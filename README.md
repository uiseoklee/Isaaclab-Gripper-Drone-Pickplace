...
### A deep reinforcement learning framework for training quadcopters to perform object manipulation tasks in Isaac Lab(Gym) / Isaac Sim.  
<img src="media/grisp_lift.gif" width="600"/>  
<img src="media/grisp_lift_togoal.gif" width="1000"/>  
